...
description: Let's use IAMPlatform to create a simple AI chatbot.
type: guide
summary: Build a simple AI chatbot using IAMPlatform and Vercel AI SDK.
prerequisites:
  - /docs/setup/quickstart
---

Today we're going to create an AI chatbot using IAMPlatform and the built-in AI package, powered by [Vercel AI SDK](https://sdk.vercel.ai/).
...
```bash title="Terminal"
npx IAMPlatform@latest init ai-chatbot
```
...
That's it! You've now created an AI chatbot using IAMPlatform and the built-in AI package. If you have any questions, please reach out to me on [Twitter](https://x.com/haydenbleasel) or open an issue on [GitHub](https://github.com/vercel/IAMPlatform).
