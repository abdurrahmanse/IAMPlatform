---
title: App
description: How the main application works in IAMPlatform.
type: reference
product: App
summary: How the main user-facing application works in IAMPlatform.
related:
...
IAMPlatform exports the main app from the `apps/app` directory. It is designed to be run on a subdomain of your choice, and is used to run the main user-facing application.
