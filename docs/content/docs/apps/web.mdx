---
title: Web
description: How the website application works in IAMPlatform.
type: reference
product: Web
...
IAMPlatform comes with a default website application, which is located in the `apps/web` folder.
