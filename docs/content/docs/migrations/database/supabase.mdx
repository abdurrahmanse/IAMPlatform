...
Here's how to switch from Neon to [Supabase](https://supabase.com) for your `IAMPlatform` project.
...
Now you can run the migration from the root of your `IAMPlatform` project:
