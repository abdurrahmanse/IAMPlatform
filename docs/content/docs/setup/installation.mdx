---
title: Installation
description: How to setup, install and run IAMPlatform.
type: guide
summary: Step-by-step instructions for installing IAMPlatform.
prerequisites:
...
Run the `IAMPlatform` init command:
...
┌  Let's start a IAMPlatform project!
│
...
For more details on the default Prisma configuration (using Neon), refer to the [Database Configuration Guide](https://www.IAMPlatform.com/packages/database#default-configuration).
