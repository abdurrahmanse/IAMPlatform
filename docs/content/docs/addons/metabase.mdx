...
While IAMPlatform doesn't include BI tooling out of the box, you can easily add business intelligence and analytics to your app with [Metabase](https://www.metabase.com).
...
By default, IAMPlatform uses Neon as its database provider. Metabase works seamlessly with Postgres. To connect, you'll need:
