---
title: Toolbar
description: IAMPlatform uses the Vercel Toolbar to allow you to override feature flags in development.
type: reference
product: Toolbar
