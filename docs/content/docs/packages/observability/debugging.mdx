---
title: Debugging
description: How we've configured debugging in IAMPlatform.
type: reference
product: Observability
summary: How debugging is configured in IAMPlatform.
related:
  - /docs/packages/observability/logging
  - /docs/packages/observability/error-capture
---

IAMPlatform has pre-configured [VSCode](https://code.visualstudio.com/) to work as a debugger. The `.vscode/launch.json` file contains the configuration for the debugger and is configured to work for all the apps in the monorepo.
