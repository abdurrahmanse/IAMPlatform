---
title: Components
description: IAMPlatform offers a default component library by shadcn/ui
type: reference
...
IAMPlatform contains a design system out of the box powered by [shadcn/ui](https://ui.shadcn.com/).
